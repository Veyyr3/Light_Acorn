...
pub struct AcornMeshAsset {
    ...
    pub indices: Vec<u16> // You say to GPU: how link your dots by pack with 3 vertices. Every vertices have own number (from 0 to 65535). 0 -> 1 -> 2 and you have triangle!
}
